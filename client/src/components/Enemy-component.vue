    ...
    created() {
        try {
            if (this.StrengthFK) {
                axios({
                    method: 'get',
                    url: 'http://localhost:6942/rarities/' + this.StrengthFK.toString(),
                    reponseType: 'stream'
                }).then((res) => {
            ...
            if (this.ResistanceFK) {
                axios({
                    method: 'get',
                    url: 'http://localhost:6942/typesw/' + this.ResistanceFK.toString(),
                    reponseType: 'stream'
                }).then((res) => {
            ...
            if (this.WeeknessFK) {
                axios({
                    method: 'get',
                    url: 'http://localhost:6942/typesw/' + this.WeeknessFK.toString(),
                    reponseType: 'stream'
                }).then((res) => {
